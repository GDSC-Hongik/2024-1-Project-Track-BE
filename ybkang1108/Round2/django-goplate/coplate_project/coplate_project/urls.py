...
urlpatterns = [
    ...
    path(
        'password/change/', #allauth 안에 있는 password/change를 오버라이딩하기 위해 앞에 씀
...
urlpatterns += static(settings.MEDIA_URL, document_root=settings.MEDIA_ROOT) # media 파일의 요청이 오면 media root로부터 돌려라